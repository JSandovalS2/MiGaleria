...
import 'package:galeria_personal/Inicio.dart';
...
class _PhotoUploadState extends State<PhotoUpload> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Subir Imagenes"),
      centerTitle: true,),
      body: Center(
        child: sampleImage == null ? Text("Selecciona una Imagen") : enableUpload(),
      ),
        ...
        child: Column(
          children: <Widget>[
            ...
            TextFormField(
              ...
              validator: (value){
                return value.isEmpty ? "Una Descripción es requerida" : null;
              },
              onSaved: (value){
